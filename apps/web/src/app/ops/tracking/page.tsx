    ...
    <div className="space-y-6">
      ...
      <section className={cardClass}>
        <p className="text-xs text-muted-foreground">
          ...
          staff: <span className="font-medium text-foreground">{filteredRows.length}</span> · Stale:{" "}
          <span className="font-medium text-amber-700 dark:text-amber-300">{staleStats.stale}</span>{" "}
